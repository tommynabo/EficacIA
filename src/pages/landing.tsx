...
import { Zap, Bot, Inbox, Users, Check } from "lucide-react"
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" className="w-full sm:w-auto text-base h-12 px-8 bg-blue-500 hover:bg-blue-600 text-white border-0" asChild>
              <Link to="/pricing">Comenzar Prueba de 7 Días</Link>
            </Button>
            <Button size="lg" variant="outline" className="w-full sm:w-auto text-base h-12 px-8 border-slate-600 text-slate-200 hover:bg-slate-800 hover:text-white">
              Ver Demo
            </Button>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="flex flex-col p-8 bg-slate-900 border-slate-800 hover:border-slate-700 transition-colors">
              ...
              <div className="flex-1 mb-8">
                <ul className="space-y-4">
                  {["Hasta 500 leads/mes", "Búsqueda en LinkedIn", "1 campaña activa", "Secuencias básicas", "Soporte por email"].map((f, i) => (
              ...
              <Button size="lg" className="w-full h-12 bg-blue-500 hover:bg-blue-600 text-white border-0" asChild>
            ...
            <Card className="flex flex-col p-8 bg-slate-800 border-blue-500/50 ring-2 ring-blue-500/20 relative">
              ...
              <div className="flex-1 mb-8">
                <ul className="space-y-4">
                  {["Leads ilimitados", "Automatización completa", "Campañas ilimitadas", "Secuencias con IA avanzada", "API access", "Soporte prioritario"].map((f, i) => (
                    <li key={i} className="flex items-center gap-3">
                      <Check className="w-5 h-5 text-green-500 shrink-0" />
                      <span className="text-slate-300">{f}</span>
                    </li>
              ...
              <Button size="lg" className="w-full h-12 bg-blue-500 hover:bg-blue-600 text-white border-0" asChild>
                <Link to="/pricing">7 Días Gratis · Más Popular</Link>
              </Button>
            </Card>
          </div>
