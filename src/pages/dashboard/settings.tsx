    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-2 border-b border-slate-800 pb-4 flex-wrap">
        {[
          ...
          { key: "proxies", label: "Proxies", badge: "Obligatorio" },
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Elige entre modo oscuro o modo claro para toda la aplicación.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-4 max-w-sm">
                ...
                <button
                  ...
                  className={`group relative p-4 rounded-xl border-2 transition-all text-left ${theme === "dark" ? "border-blue-500 bg-blue-500/5" : "border-slate-700 hover:border-slate-500"}`}
                >
                  <div className="w-full h-20 rounded-lg bg-slate-900 border border-slate-700 mb-3 overflow-hidden flex flex-col gap-1.5 p-2">
                    <div className="w-3/4 h-2 bg-slate-700 rounded" />
                    <div className="w-1/2 h-2 bg-slate-800 rounded" />
                    <div className="w-full h-8 bg-slate-800 rounded mt-auto" />
                  </div>
                  <div className="flex items-center gap-2">
                    <Moon className="w-4 h-4 text-slate-400" />
                    <p className="text-sm font-medium text-slate-200">Oscuro</p>
                  </div>
                  {theme === "dark" && (
                ...
                <button
                  ...
                  className={`group relative p-4 rounded-xl border-2 transition-all text-left ${theme === "light" ? "border-blue-500 bg-blue-500/5" : "border-slate-700 hover:border-slate-500"}`}
                >
                  <div className="w-full h-20 rounded-lg bg-white border border-slate-200 mb-3 overflow-hidden flex flex-col gap-1.5 p-2">
                    <div className="w-3/4 h-2 bg-slate-200 rounded" />
                    <div className="w-1/2 h-2 bg-slate-100 rounded" />
                    <div className="w-full h-8 bg-slate-100 rounded mt-auto" />
                  </div>
                  <div className="flex items-center gap-2">
                    <Sun className="w-4 h-4 text-amber-400" />
                    <p className="text-sm font-medium text-slate-200">Claro</p>
                  </div>
                  {theme === "light" && (
                    <p className="text-xs text-blue-400 mt-1 flex items-center gap-1">
                      <CheckCircle2 className="w-3 h-3" /> Activo
