...
var Popup = () => {
  ...
  const [backendUrl, setBackendUrl] = (0, import_react3.useState)("https://eficac-ia.vercel.app");
  const [campaigns, setCampaigns] = (0, import_react3.useState)([]);
  const [selectedCampaign, setSelectedCampaign] = (0, import_react3.useState)("");
  ...
  const fetchCampaigns = async () => {
    ...
    try {
      ...
      if (response.status === 401) {
        ...
        if (typeof chrome !== "undefined" && chrome.storage) {
          chrome.storage.local.remove(["token"], () => {
            ...
            setView("settings");
            setStatus("error");
            setErrorMessage("Tu token de conexi\xF3n es inv\xE1lido o ha expirado. Genera uno nuevo en Ajustes.");
          });
        }
        return;
      }
      ...
      setStatus("error");
      setErrorMessage(
        err.message === "Failed to fetch" ? "Error de red. Verifica que la URL del backend sea correcta." : `Error: ${err.message}`
      );
    }
  };
  ...
  const startScraping = async () => {
    if (!selectedCampaign) {
      setStatus("error");
      setErrorMessage("Selecciona una campa\xF1a");
      return;
    }
    try {
      setIsScraping(true);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "w-[350px] min-h-[450px] bg-zinc-950 text-zinc-200 flex flex-col font-sans antialiased border border-zinc-800 shadow-2xl overflow-hidden rounded-lg", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between p-4 border-b border-zinc-800 bg-zinc-900/50", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-8 h-8 rounded-lg bg-blue-500 flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", className: "text-white", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M13 2L3 14h9l-1 8 10-12h-9l1-8z" }) }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { className: "font-bold text-lg tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-zinc-400", children: "EficacIA" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Settings, { className: "w-5 h-5" })
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "p-5 flex-1 flex flex-col", children: view === "settings" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col gap-5 animate-in fade-in slide-in-from-right-4 duration-300", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "text-xs font-bold text-zinc-500 uppercase tracking-widest", children: "URL del Backend" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "text-xs font-bold text-zinc-500 uppercase tracking-widest", children: "Token de Conexi\xF3n (API Key)" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "textarea",
            {
              value: token,
    ...
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex flex-col gap-6 animate-in fade-in slide-in-from-left-4 duration-300", children: !token ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col items-center justify-center py-12 text-center gap-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "w-12 h-12 text-zinc-700" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-1", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm font-medium", children: "Falta configuraci\xF3n" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs text-zinc-500", children: "Configura tu token para empezar a extraer leads." })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "text-xs font-bold text-zinc-500 uppercase tracking-widest", children: "Campa\xF1a de Destino" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "relative", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "", disabled: true, children: "Selecciona una campa\xF1a" }),
                campaigns.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: c.id, children: c.name }, c.id))
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-zinc-600", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Download, { className: "w-4 h-4" }) })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "text-xs font-bold text-zinc-500 uppercase tracking-widest", children: "Cantidad a extraer" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex flex-col gap-1", children: [10, 50, 100].map((val) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col gap-4 mt-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "button",
          {
            ...
            className: cn(
              ...
              isScraping ? "bg-zinc-800 text-zinc-500 cursor-not-allowed border border-zinc-700" : "bg-blue-600 text-white hover:bg-blue-500 shadow-xl shadow-blue-900/30 hover:shadow-blue-500/40"
            ),
            children: [
              isScraping ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "w-5 h-5 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Download, { className: "w-5 h-5 shrink-0" }),
              isScraping ? "EXTRAYENDO..." : "A\xD1ADIR LEADS"
            ]
          }
        ),
        (isScraping || progress > 0) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-3 p-4 bg-zinc-900/50 rounded-xl border border-zinc-800 animate-in fade-in zoom-in-95 duration-200", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-full h-2 bg-zinc-800 rounded-full overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
      ...
      status === "success" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3 text-emerald-400 bg-emerald-500/10 p-4 rounded-xl border border-emerald-500/20 animate-in slide-in-from-bottom-2 duration-300", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheckBig, { className: "w-6 h-6 flex-shrink-0" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-xs font-bold leading-tight", children: "\xA1Leads a\xF1adidos con \xE9xito a la campa\xF1a!" })
      ] }),
      status === "error" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3 text-rose-400 bg-rose-500/10 p-4 rounded-xl border border-rose-500/20 animate-in slide-in-from-bottom-2 duration-300", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "w-6 h-6 flex-shrink-0" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-xs font-bold leading-tight", children: errorMessage || "Error al procesar" })
      ] })
    ] }) }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "p-4 border-t border-zinc-800 bg-zinc-900/30 flex justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "a",
      {
        href: backendUrl,
        target: "_blank",
...
import_client.default.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react4.default.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Popup_default, {}) })
);
